        ...
        if Intento['tag'] == Etiqueta:
            ...
            if Intento['tag'] == "fecha":
                ...
                return [
                    ...
                    '\n<button class="info" onclick="Mostrar(\'Informatica\')">Informatica <span class="bienes">Equipo de Computo</span></button><b> </b>'
                    '\n<button class="info" onclick="Mostrar(\'Biomédica\')">Biomédica <span class="bienes">Equipo Médico</span></button><b> </b>'
                    '\n<button class="info" onclick="Mostrar(\'Mantenimiento\')">Mantenimiento <span class="bienes">Mobiliario</span></button><b> </b>'
                    '\n<button class="info" onclick="Mostrar(\'Servicios Generales\')">Servicios Generales <span class="bienes">Automóviles, Camillas, Sillas de Ruedas, etc.</span></button><b> </b>'
                    '\n<button class="info" onclick="Mostrar(\'Subdirección Medica\')">Sub Medica <span class="bienes">Reactivos y Medicamentos</span></button><b> </b>'
                    '\n<button class="info" onclick="Mostrar(\'Subdirección Administrativa\')">Sub Administrativa <span class="bienes">Cualquier otro activo</span></button><b> </b>',
                ...
                return generar_respuesta_area(nombre_area="Enseñanza Dos ", emoji="📚", piso="6", encargado="Dr. Alberto Paez Salazar \nEnf. Alba Berenice Madueño Madrigal",
                    extensiones=[("Enseñanza Dos", "7033")]
                )
            elif Intento['tag'] == "ensenanza_investigacion":
                return generar_respuesta_area(nombre_area="Enseñanza e Investigación ", emoji="📖", piso="4", encargado="Dr. Alberto Paez Salazar \nEnf. Alba Berenice Madueño Madrigal",
